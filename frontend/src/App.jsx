  ...
  return (
    <>
      ...
      <div className="header-top">
        ...
        {!isAdmin && (
          <div className="month-controls-with-actions">
            ...
            <div className="header-actions">
              <button className="btn-action" onClick={() => setShowChart(true)} title="Ver gráfico de vendas">
                📊
              </button>
              <button className="btn-action" onClick={() => setShowNotes(true)} title="Ver rascunhos e anotações">
                📝
              </button>
            </div>
          </div>
